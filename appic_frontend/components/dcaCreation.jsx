...
import { applyDecimals, formatDecimalValue, formatSignificantNumber } from '@/helper/number_formatter';
...
export default function DcaCreation({ setPositionStatus }) {
  ...
  const searchinput = (tokens, query) => {
    console.log(tokens);
              ...
              return (
                ...
                >
                  ...
                  <div className="token_balance">
                    <h3>{formatSignificantNumber(applyDecimals(token.balance, token.decimals))}</h3>
                  </div>
                </div>
              );
            })}
